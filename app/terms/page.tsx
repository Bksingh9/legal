...
export default function TermsPage() {
  return (
    <PolicyShell
      ...
      description="The agreement that governs your use of LegalDesk AI."
    ...
    >
      ...
      <p>
        You agree not to use the Platform for unlawful purposes, to harass advocates,
        or to upload material that infringes third-party rights.
      </p>

      <h2>7. Recording and consent</h2>
      <p>
        Consultation calls are recorded only after both you and the advocate consent.
        Recordings are stored in India.
      </p>
      ...
      <p>
        These Terms are governed by the laws of India. Courts at Bengaluru shall have
        exclusive jurisdiction.
      </p>

      <h2>10. Contact</h2>
      <p>
        Email <a href="mailto:hello@legaldesk.ai">hello@legaldesk.ai</a> for any
